  ...
  return (
    <section ref={sectionRef} id="precos" className="pt-24 md:pt-32 pb-16 md:pb-20" style={{ background: "#F5F7FA" }}>
      <div className="container mx-auto px-4">
        ...
        {/* CARD 4 — Kit Shot Rush + Cápsulas (linha destacada) */}
        <div className="max-w-6xl mx-auto mb-10">
          <article
            id="card-kit-rush"
            className="relative bg-white rounded-2xl border border-[#E8ECF1] overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12"
          >
