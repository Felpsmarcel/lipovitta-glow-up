...
const Afiliados = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Fire-and-forget notification email — not critical for UX
    try {
      ...
      // silent — dado está salvo no banco
    }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        title="Programa de Afiliadas LipoVitta"
        description="Cadastre-se no programa de afiliadas LipoVitta. Divulgue produtos de cuidado para lipedema e receba comissões."
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          {success ? (
            <div className="bg-white border border-[#9BAE52]/40 rounded-2xl p-8 md:p-10 text-center shadow-sm">
              ...
              <h2 className="font-serif text-2xl text-[#4667B4] mb-2">Recebemos seu cadastro</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <Field label="Quantidade de seguidores" error={errors.followers_range}>
                  <select
                    ...
                    onChange={update("followers_range")}
                    className={inputCls(errors.followers_range)}
                  >
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        name="knows_product"
                        value={opt.v}
                        checked={form.knows_product === opt.v}
                        onChange={update("knows_product")}
                        className="sr-only"
                      />
                      {opt.l}
                    </label>
